...
NUM_MOVES     EQU 4
NUM_STATS     EQU 5
NUM_STAT_MODS EQU 6		; IDDJY decreased from 8 since the last 2 are not used
NUM_DVS       EQU 2
...
NAME_LENGTH EQU 11
TRAINER_NAME_LENGTH EQU 13	; IDDJY
...
BATTLE_TYPE_SIMULATOR  EQU 3	; IDDJY added this type to distinguish battle simulator from other battles
