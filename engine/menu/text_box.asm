...
.coordTableMatch
	...
	call TextBoxBorder
	ld a, [wBattleType]
	cp BATTLE_TYPE_SIMULATOR
	ret nz
	coord hl, 7, 12							; IDDJY
	ld de, TurnString						; IDDJY
	call PlaceString						; IDDJY
	ld de, wTurnCounter						; IDDJY add turn counter on the top border
	coord hl, 12, 12						; IDDJY
	lb bc, LEFT_ALIGN | 2, 5				; IDDJY
