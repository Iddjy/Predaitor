...
; IDDJY renamed from _AIBattleUseItemText
_AIBattleUseItemText_Enemy::
	TX_RAM wTrainerName
	text ""
	line "used @"
	TX_RAM wcd6d
...
; IDDJY made this and its equivalent for the player the same
_MultiHitText::
...
; IDDJY made this and its equivalent for the enemy the same
_HitXTimesText::
