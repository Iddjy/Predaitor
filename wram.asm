...
; IDDJY add this for the player AI
wPlayerAILayer2Encouragement:: ; ccd6
	ds 1
...
; IDDJY variable used to display an arrow in the HUD when the mon is attacking
; allows to distinguish which mon is attacking in mirror matches
; 0 : no one is attacking
; 1 : trainer 1 (player) is attacking
; 2 : trainer 2 (enemy) is attacking
wWhoIsAttacking:: ; ccda
	ds 1
...
; IDDJY add this variable for the player AI
wPlayerAICount:: ; cce0
	ds 1

; IDDJY add this to track cursor position in the battle setup menu
wBattleSetupMenuPos:: ; cce1
	ds 1
...
; IDDJY toggle to switch between custom DVs/StatExp and standard DVs/NoStatExp
wUseCustomDVsAndStatExp:: ; cd20
	ds 1

; IDDJY add this variable to hold the selected level for level scaling
wLevelScaling:: ; cd21
	ds 1

; IDDJY toggle item use activation in the battle simulator
wEnableItems:: ; cd22
	ds 1
...
; IDDJY add this variable to store the player's trainer index in its trainer class
wPlayerNo::	; cd35
	ds 1

; IDDJY add this variable to store the trainer class for the player side
wPlayerClass:: ; cd36
	ds 1

; IDDJY toggle PP depletion for battle simulator
wInfinitePPs::
	ds 1

; IDDJY toggle to decide whether moves adapt to level scaling or if we keep original moves independently of level scaling
wMovesScaling::
	ds 1
...
; IDDJY add this to set which battle music to play during battle
; IDDJY also used to choose which victory music to play at the end of the battle
; 0 = normal trainer music
; 1 = gym leader music
; 2 = final battle music
; >2 = wild mon music
wBattleMusic:: ; cd3c
	ds 1
...
wTurnCounter::		; IDDJY use these bytes as turn counter in battle simulator
...
wGymCityName:: ; cf5f
wTrainerNameTemp::	; IDDJY add this to hold the trainer name when displaying their team
	ds 17
...
wItemList:: ; cf7b
wTrainerClassTemp::	; IDDJY add this to hold the trainer class when displaying a trainer's team or a class
wTeamDataTemp::	; IDDJY add this to hold the party data when displaying a trainer's team
	ds 16
...
; IDDJY in battle simulator, this is 3
	ds 1
...
wPartyMonOT::    ds TRAINER_NAME_LENGTH * PARTY_LENGTH ; d273
...
wEnemyMonOT::    ds TRAINER_NAME_LENGTH * PARTY_LENGTH ; d9ac
...
wDayCareMonOT::   ds TRAINER_NAME_LENGTH ; da54
...
wBoxMonOT::    ds TRAINER_NAME_LENGTH * MONS_PER_BOX ; dd2a
