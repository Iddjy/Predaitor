...
.Enemy
	; IDDJY removed the Enemy prefix when the opponent's mon name is printed
...
Char58:: ; prompt
	ld a, [wIsInBattle]			; IDDJY check if we're in a trainer battle instead of a link battle
	cp 2						; IDDJY 
	jp z, .ok
	ld a, "▼"
	Coorda 18, 16
...
; (no arguments)
TextCommand06::
	ld a, [wIsInBattle]			; IDDJY check for trainer battle instead of link battle
	cp 2						; IDDJY
	jp z, TextCommand0D
	ld a, "▼"
