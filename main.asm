...
INCLUDE "engine/battle/moveEffects/heal_effect.asm"						; IDDJY moved this from bank E
INCLUDE "engine/battle/moveEffects/transform_effect.asm"				; IDDJY moved this from bank E
INCLUDE "engine/battle/moveEffects/reflect_light_screen_effect.asm"		; IDDJY moved this from bank E
...
INCLUDE "engine/menu/battle_setup_class.asm"
...
TradingAnimationGraphics:								; IDDJY moved from bank E
INCBIN "gfx/game_boy.2bpp"								; IDDJY moved from bank E
INCBIN "gfx/link_cable.2bpp"							; IDDJY moved from bank E
TradingAnimationGraphicsEnd:							; IDDJY moved from bank E

; Pokeball traveling through the link cable.			; IDDJY moved from bank E
TradingAnimationGraphics2: INCBIN "gfx/trade2.2bpp"		; IDDJY moved from bank E
TradingAnimationGraphics2End:							; IDDJY moved from bank E
...
SECTION "Trainer Parties", ROMX			; Bank 2D : IDDJY added this so that trainer parties have a whole bank to themselves

INCLUDE "engine/battle/read_trainer_party.asm"
INCLUDE "data/trainer_parties.asm"


SECTION "Trainer Individual Names", ROMX	; Bank 2E : IDDJY added this so that trainer individual names have a whole bank to themselves

INCLUDE "data/individual_trainer_names.asm"
INCLUDE "engine/menu/battle_setup_name.asm"


SECTION "Trainer Pics", ROMX	; Bank 2F : IDDJY moved from bank $13 so that trainer pics have a whole bank to themselves
...
GiovanniPic::      INCBIN "pic/trainer/mitch.pic"
...
BrunoPic::         INCBIN "pic/trainer/steve.pic"
BrockPic::         INCBIN "pic/trainer/gene.pic"
MistyPic::         INCBIN "pic/trainer/amy.pic"
LtSurgePic::       INCBIN "pic/trainer/isaac.pic"
ErikaPic::         INCBIN "pic/trainer/nikki.pic"
KogaPic::          INCBIN "pic/trainer/rick.pic"
BlainePic::        INCBIN "pic/trainer/ken.pic"
SabrinaPic::       INCBIN "pic/trainer/murray.pic"
...
Rival3Pic::        INCBIN "pic/trainer/ronald.pic"
LoreleiPic::       INCBIN "pic/trainer/courtney.pic"
ChannelerPic::     INCBIN "pic/trainer/channeler.pic"
;AgathaPic::        INCBIN "pic/trainer/agatha.pic"
;LancePic::         INCBIN "pic/trainer/lance.pic"
AgathaPic::        INCBIN "pic/trainer/jack.pic"
LancePic::         INCBIN "pic/trainer/rod.pic"
